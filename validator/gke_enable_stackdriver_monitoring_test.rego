...
all_violations[violation] {
	resource := data.test.fixtures.gke_enable_stackdriver_monitoring.assets[_]
	constraint := data.test.fixtures.gke_enable_stackdriver_monitoring.constraints.enable_gke_stackdriver_monitoring
...
test_stackdriver_monitoring_disabled {
	violation := all_violations[_]
